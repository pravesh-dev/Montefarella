...
function ContactForm() {
  return (
    <div className='w-64 bg-[#2e2b2c] p-5 absolute left-1/2 -bottom-44 -translate-x-1/2 text-white md:left-[60%] md:translate-x-0 lg:w-96 lg:p-10 lg:left-[65%] lg:-bottom-64'>
