    ...
    <div>
      <header class="w-full flex justify-between items-center py-5 px-2 md:px-10 lg:px-20 fixed top-0 left-0 bg-black/20 backdrop-blur-sm z-[99] text-white">
        ...
        <nav class={`flex flex-col md:flex-row bg-neutral-900 md:bg-transparent w-80 py-20 gap-5 items-center fixed top-0 h-screen md:static md:w-auto md:gap-6 lg:gap-16 md:h-auto md:py-0 ${isMenuOpen ? 'left-0' : '-left-full'} duration-150 font-poppins z-[99]`}>
          <Link
            class="w-full py-3 bg-[#c095691b] text-center nav_items active hover:text-primary text-primary tracking-[1px] border-b-2 border-primary md:w-auto md:py-0 md:bg-transparent md:border-none"
            to="/"
          >
            HOME
          </Link>
          <Link
            class="w-full py-3 bg-[#c095691b] text-center nav_items hover:text-primary tracking-[1px] border-b-2 border-primary md:w-auto md:py-0 md:bg-transparent md:border-none"
            to="/about"
          >
            ABOUT
          </Link>
          ...
          <Link class="w-full py-3 bg-[#c095691b] text-center nav_items hover:text-primary tracking-[1px] border-b-2 border-primary md:w-auto md:py-0 md:bg-transparent md:border-none" to="/contact">
            CONTACT US
          </Link>
